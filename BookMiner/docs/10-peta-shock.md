...
| `book/backup/peta_book-....db` | 通常定跡 DB を peta shock 化した DB。`peta_next`、`peta_next_refutation`、`peta_next_gap`、`peta_unsolved`、`peta_opponent`、対局用の基本入力です。外部で作った `.ybb` も `peta_read` で読み込めます。 |
