...
そのため、GUI のボタン、ログ欄、progress bar、`peta_shock`、`peta_shock_latest`、`peta_read`、`peta next`、`peta refutation`、`peta rejoin`、`peta unsolved`、`peta opponent`、`enqueue` の考え方は Python 版と同じです。
