...
基本的な考え方、`peta_shock`、`peta_read`、`peta next`、`peta_next_refutation`、`peta_refutation`、`peta_depth_gap`、`peta_unsolved`、`peta_opponent`、`enqueue`、`eval_limit`、GUI の操作手順は Python 版 BookMiner と同じです。
