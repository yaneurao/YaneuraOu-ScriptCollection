...
基本的な考え方、`peta_shock`、`peta_shock_latest`、`peta_read`、`peta next`、`peta refutation`、`peta rejoin`、`peta unsolved`、`peta opponent`、`enqueue`、`eval_limit`、GUI の操作手順は Python 版 BookMiner と同じです。
